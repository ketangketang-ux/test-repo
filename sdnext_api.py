%%writefile /content/sdnext_api.py
...
GPU_TYPE = os.environ.get("MODAL_GPU_TYPE", "L4")  # default L4

# --- Build image (clone repo + deps) ---
image = (
...
def run():
    ...
    @app_api.get("/")
    def root():
        return JSONResponse({"status": "ok", "message": "SD.Next backend running"})
